...
The project homepage [has a community page](https://flutter.io/community) that provides links to some of these of these forums, and a few that I do not touch on here.
...
[pub.dartlang.org](https://pub.dartlang.org) is the official site for the community to share packages. It should be your first port of call if you suspect that you are working on a hard problem that perhaps has been solved before. The search feature is robust, the presentation let's you decide quickly if a package has the functionality you want, and their are useful links to get you started and help you succeed.
...
[Discord](https://discord.gg/p7Aj8wF) is quite active. The nice thing about the Discord server is that the it is split into channels the way an active Slack server is. #beginner and #intermediate get many questions a day. The community there can be very interactive trying to help people solve their issues.
...
There is [one person](https://github.com/RandalSchwartz) that seems to be on Gitter at all times, and provides a lot of the interactivity, whereas Discord seems to have 4 or 5 fairly active participants.
...
## Links
 * [Rapido Flutter Package on Github](https://github.com/rapido-mobile/rapido-flutter)
 * [Get Rapido Package](https://pub.dartlang.org/packages/rapido)
 * [Rapido Youtube Channel](https://www.youtube.com/channel/UCeoRpyhpNJmiMuAEJ4WRljg?view_as=subscriber)
 * [Tutorials and articles](https://rapido-mobile.github.io/)
